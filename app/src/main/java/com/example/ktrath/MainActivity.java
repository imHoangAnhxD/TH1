...
import com.example.ktrath.model.Cat;
import com.example.ktrath.model.CatAdapter;
import com.example.ktrath.model.SpinnerAdapter;
...
public class MainActivity extends AppCompatActivity implements CatAdapter.CatItemListener, SearchView.OnQueryTextListener {
    ...
    private void filter(String s){
        ...
        if(filterlist.isEmpty()){
            Toast.makeText(this,"Không tìm được gì",Toast.LENGTH_SHORT).show();
        }else{
